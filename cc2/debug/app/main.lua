...
(function()
    ...
    local ____class_0 = __TS__Class()
    ____class_0.name = "Assert"
    function ____class_0.prototype.____constructor(self)
    end
    function ____class_0.fail(self, message)
        error(
            __TS__New(Error, message),
            0
        )
    end
    function ____class_0.pass(self, reason)
    end
    local Assert = ____class_0
    local ____class_1 = __TS__Class()
    ____class_1.name = "Lua"
    function ____class_1.prototype.____constructor(self)
    end
    function ____class_1.literal(self, luaVersion)
        error(
            __TS__New(
                Error,
    ...
    function _Result.error(self, errorMessage)
        local ____Result_7 = _Result
        local ____errorMessage_6 = errorMessage
        if ____errorMessage_6 == nil then
            ____errorMessage_6 = "No error message given"
        end
        return __TS__New(____Result_7, nil, ____errorMessage_6)
    end
    ...
    function _Result.prototype.getValueUnsafe(self, message)
        if not self.value then
            local ____Error_10 = Error
            local ____message_8 = message
            if ____message_8 == nil then
                ____message_8 = self.errorMessage
            end
            local ____message_8_9 = ____message_8
            if ____message_8_9 == nil then
                ____message_8_9 = "Cannot unwrap `Result` value"
            end
            error(
                __TS__New(____Error_10, ____message_8_9),
                0
            )
        end
        return self.value
    ...
    function _Result.prototype.getValueOrDefault(self, defaultValue)
        local ____self_value_11 = self.value
        if ____self_value_11 == nil then
            ____self_value_11 = defaultValue
        end
        return ____self_value_11
    end
    ...
    ____class_16.name = "Reflection"
    function ____class_16.prototype.____constructor(self)
    end
    function ____class_16.getFields(self, ____table)
    ...
    function ____class_16.getField(self, ____table, name)
    ...
    ____class_19.level = "DEBUG"
    ____class_19.levelMap = __TS__New(Map, {{"DEBUG", 0}, {"INFO", 1}, {"WARN", 2}, {"ERROR", 3}})
    ...
    ____class_20.name = "Test"
    function ____class_20.prototype.____constructor(self)
    end
    function ____class_20.prototype.run(self)
        local name = self:getTestInfo().name
        Logger:info((" * Running '" .. tostring(name)) .. "'...'")
        ...
        Logger:info((((((" * '" .. tostring(name)) .. "' ") .. tostring(passed:size())) .. "/") .. tostring(results:size())) .. " passed")
        passed:forEach(function(____, result) return Logger:debug((("PASS " .. tostring(result.name)) .. ": ") .. tostring(result.message)) end)
        failed:forEach(function(____, result) return Logger:error((("FAIL " .. tostring(result.name)) .. ": ") .. tostring(result.message)) end)
        return results
    end
    function ____class_20.prototype.gatherTestCases(self)
        return Reflection:getMethods(self):whereKeys(function(____, key) return key:startsWith("test") end):selectKeys(function(____, key) return key:replace("test", ""):toLowerCase() end)
    end
    function ____class_20.prototype.runTestCase(self, name, test)
        self:beforeEach()
        do
            local function ____catch(cause)
                print((("Test \"" .. tostring(name)) .. "\" failed: ") .. tostring(cause))
                return true, {
                    name = name,
                    passed = false,
    ...
    function ____class_20.prototype.beforeAll(self)
    end
    function ____class_20.prototype.afterAll(self)
    end
    function ____class_20.prototype.beforeEach(self)
    end
    function ____class_20.prototype.afterEach(self)
    end
    local Test = ____class_20
    local ____class_21 = __TS__Class()
    ____class_21.name = "ExampleTest"
    __TS__ClassExtends(____class_21, Test)
    function ____class_21.prototype.getTestInfo(self)
        return {name = "ExampleTest", description = "An example of how tests could be defined"}
    end
    function ____class_21.prototype.testFirstExample(self)
        print("First example test running!")
        Assert:fail("This test should fail")
    end
    function ____class_21.prototype.testSecondExampleShouldPass(self)
        print("Second example test running!")
        Assert:pass("This test should pass as it does nothing and is an example.")
    end
    local ExampleTest = ____class_21
    local ____class_22 = __TS__Class()
    ____class_22.name = "ExecutionContext"
    function ____class_22.prototype.____constructor(self)
    end
    ____class_22.commandLineArguments = LuaList:ofTable(COMMAND_LINE_ARGUMENTS)
    local ExecutionContext = ____class_22
    local ____class_23 = __TS__Class()
    ____class_23.name = "FileReadHandle"
    function ____class_23.prototype.____constructor(self, handle)
        self.handle = handle
    end
    function ____class_23.prototype.readBytes(self, count)
        return self.handle.read(count)
    end
    function ____class_23.prototype.readAllContent(self)
        return self.handle.readAll()
    end
    function ____class_23.prototype.readLine(self, includeTrailingNewline)
        if includeTrailingNewline == nil then
            includeTrailingNewline = false
        end
        return self.handle.readLine(includeTrailingNewline)
    end
    function ____class_23.prototype.seekPosition(self, whence, offset)
        if whence == nil then
            whence = "cur"
        end
        if offset == nil then
    ...
    function ____class_23.prototype.close(self)
        self.handle.close()
    end
    local FileReadHandle = ____class_23
    local ____class_24 = __TS__Class()
    ____class_24.name = "FileReadWriteHandle"
    function ____class_24.prototype.____constructor(self, handle)
        self.handle = handle
    end
    function ____class_24.prototype.readBytes(self, count)
        return self.handle.read(count)
    end
    function ____class_24.prototype.readAllContent(self)
        return self.handle.readAll()
    end
    function ____class_24.prototype.readLine(self, includeTrailingNewline)
        if includeTrailingNewline == nil then
            includeTrailingNewline = false
        end
        return self.handle.readLine(includeTrailingNewline)
    end
    function ____class_24.prototype.writeContent(self, content)
        self.handle.write(content)
    end
    function ____class_24.prototype.writeLine(self, text)
        self.handle.writeLine(text)
    end
    function ____class_24.prototype.flushBuffers(self)
        self.handle.flush()
    end
    function ____class_24.prototype.seekPosition(self, whence, offset)
        if whence == nil then
            whence = "cur"
        end
        if offset == nil then
    ...
    function ____class_24.prototype.close(self)
        self.handle.close()
    end
    local FileReadWriteHandle = ____class_24
    local ____class_25 = __TS__Class()
    ____class_25.name = "FileWriteHandle"
    function ____class_25.prototype.____constructor(self, handle)
        self.handle = handle
    end
    function ____class_25.prototype.writeContent(self, content)
        self.handle.write(content)
    end
    function ____class_25.prototype.writeLine(self, text)
        self.handle.writeLine(text)
    end
    function ____class_25.prototype.flushBuffers(self)
        self.handle.flush()
    end
    function ____class_25.prototype.seekPosition(self, whence, offset)
        if whence == nil then
            whence = "cur"
        end
        if offset == nil then
    ...
    function ____class_25.prototype.close(self)
        self.handle.close()
    end
    local FileWriteHandle = ____class_25
    local ____class_26 = __TS__Class()
    ____class_26.name = "CcFs"
    function ____class_26.prototype.____constructor(self)
    end
    function ____class_26.completeFileName(self, path, location, includeFiles, includeDirectories)
    ...
    function ____class_26.findFiles(self, path)
        return fs.find(path)
    end
    function ____class_26.isDriveRootDirectory(self, path)
        return fs.isDriveRoot(path)
    end
    function ____class_26.listDirectory(self, path)
        return fs.list(path)
    end
    function ____class_26.combinePath(self, ...)
        local paths = {...}
        local pathsTable = TableUtil:fromArray(paths)
        return fs.combine(table.unpack(pathsTable))
    end
    function ____class_26.getFileName(self, path)
        return fs.getName(path)
    end
    function ____class_26.getDirectoryName(self, path)
        return fs.getDir(path)
    end
    function ____class_26.getFileSize(self, path)
        return fs.getSize(path)
    end
    function ____class_26.fileExists(self, path)
        return fs.exists(path)
    end
    function ____class_26.isDirectory(self, path)
        return fs.isDir(path)
    end
    function ____class_26.isReadOnly(self, path)
        return fs.isReadOnly(path)
    end
    function ____class_26.createDirectory(self, path)
        fs.makeDir(path)
    end
    function ____class_26.move(self, sourcePath, destinationPath)
        fs.move(sourcePath, destinationPath)
    end
    function ____class_26.copy(self, sourcePath, destinationPath)
        fs.copy(sourcePath, destinationPath)
    end
    function ____class_26.delete(self, path)
        fs.delete(path)
    end
    function ____class_26.openFileForReading(self, path)
    ...
    function ____class_26.openFileForWriting(self, path)
        local fileHandle = nil
        local errorMessage = nil
    ...
    function ____class_26.openFileForReadAndWrite(self, path)
        local fileHandle = nil
        local errorMessage = nil
    ...
    function ____class_26.openFileForAppending(self, path)
        local fileHandle = nil
        local errorMessage = nil
    ...
    function ____class_26.openFileForBinaryReading(self, path)
        local fileHandle = nil
        local errorMessage = nil
    ...
    function ____class_26.openFileForBinaryWriting(self, path)
        local fileHandle = nil
        local errorMessage = nil
    ...
    function ____class_26.getDriveName(self, path)
        return Optional:ofNullable(fs.getDrive(path))
    end
    function ____class_26.getFreeSpaceOnDrive(self, path)
        return fs.getFreeSpace(path)
    end
    function ____class_26.getDriveCapacity(self, path)
        return Optional:ofNullable(fs.getCapacity(path))
    end
    function ____class_26.getFileAttributes(self, path)
        return fs.attributes(path)
    end
    local CcFs = ____class_26
    ...
    function _FileUtil.writeText(self, path, content)
        ...
        do
            local function ____catch(e)
                ...
                if e ~= nil then
                    ____opt_result_29 = e.message
                end
                return true, ____Result_error_30(Result, ____opt_result_29)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
    ...
    function _FileUtil.appendText(self, path, content)
        ...
        do
            local function ____catch(e)
                local ____Result_error_34 = Result.error
                local ____opt_result_33
                if e ~= nil then
                    ____opt_result_33 = e.message
                end
                return true, ____Result_error_34(Result, ____opt_result_33)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
                handle:writeContent(content)
            end)
    ...
    function _FileUtil.deleteFile(self, path)
        do
            local function ____catch(e)
                local ____Result_error_38 = Result.error
                local ____opt_result_37
                if e ~= nil then
                    ____opt_result_37 = e.message
                end
                return true, ____Result_error_38(Result, ____opt_result_37)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
                CcFs:delete(path)
    ...
    function _FileUtil.copyFile(self, source, destination)
        do
            local function ____catch(e)
                local ____Result_error_42 = Result.error
                local ____opt_result_41
                if e ~= nil then
                    ____opt_result_41 = e.message
                end
                return true, ____Result_error_42(Result, ____opt_result_41)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
    ...
    function _FileUtil.getFileSize(self, path)
        local ____self_47 = _FileUtil:readText(path)
        return ____self_47["then"](
            ____self_47,
    ...
    function _FileUtil.createDirectory(self, path)
        do
            local function ____catch(e)
                local ____Result_error_51 = Result.error
                local ____opt_result_50
                if e ~= nil then
                    ____opt_result_50 = e.message
                end
                return true, ____Result_error_51(Result, ____opt_result_50)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
    ...
    function _FileUtil.copyDirectory(self, source, destination)
        do
            local function ____catch(e)
                local ____Result_error_55 = Result.error
                local ____opt_result_54
                if e ~= nil then
                    ____opt_result_54 = e.message
                end
                return true, ____Result_error_55(Result, ____opt_result_54)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
                CcFs:copy(source, destination)
                return true, Result:void()
    ...
    function _FileUtil.moveDirectory(self, source, destination)
        do
            local function ____catch(e)
                local ____Result_error_59 = Result.error
                local ____opt_result_58
                if e ~= nil then
                    ____opt_result_58 = e.message
                end
                return true, ____Result_error_59(Result, ____opt_result_58)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
                CcFs:move(source, destination)
                return true, Result:void()
    ...
    function _FileUtil.deleteDirectory(self, path)
        do
            local function ____catch(e)
                local ____Result_error_63 = Result.error
                local ____opt_result_62
                if e ~= nil then
                    ____opt_result_62 = e.message
                end
                return true, ____Result_error_63(Result, ____opt_result_62)
            end
            local ____try, ____hasReturned, ____returnValue = pcall(function()
                CcFs:delete(path)
                return true, Result:void()
    ...
    ____class_64.name = "CcTextUtils"
    function ____class_64.prototype.____constructor(self)
    end
    function ____class_64.slowWrite(self, text, rate)
        textutils.slowWrite(text, rate)
    end
    function ____class_64.slowPrint(self, text, rate)
        textutils.slowPrint(text, rate)
    end
    function ____class_64.formatTime(self, time, twentyFourHour)
        local result = ""
        result = textutils.formatTime(time, twentyFourHour)
        return result
    end
    function ____class_64.pagedPrint(self, text, freeLines)
        local result = 0
        result = textutils.pagedPrint(text, freeLines)
        return result
    end
    function ____class_64.tabulate(self, ...)
        textutils.tabulate(...)
    end
    function ____class_64.pagedTabulate(self, ...)
        textutils.pagedTabulate(...)
    end
    function ____class_64.serialize(self, obj, opts)
        local result = nil
        local errorMessage = nil
    ...
    function ____class_64.unserialize(self, str)
        local result = nil
    ...
    function ____class_64.serializeJSON(self, obj, opts)
        local result = nil
        local errorMessage = nil
    ...
    function ____class_64.unserializeJSON(self, str, opts)
        local result = nil
        local errorMessage = nil
    ...
    function ____class_64.urlEncode(self, str)
        local result = ""
        result = textutils.urlEncode(str)
        return result
    end
    function ____class_64.getCompletion(self, searchText, searchTable)
        local result = {}
        result = textutils.complete(searchText, searchTable)
        return result
    end
    ____class_64.empty_json_array = {}
    ____class_64.json_null = {}
    local CcTextUtils = ____class_64
    ...
    ____class_70.name = "TestsEntrypoint"
    ...
    local TestsEntrypoint = ____class_70
